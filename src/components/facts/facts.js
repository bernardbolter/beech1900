      ...
      <Header match={this.props.match} />
        ...
        <h1>Facts about the Beech 1900</h1>
          <div className="facts_info">
            ...
            <img src={`${process.env.PUBLIC_URL}/factory1.jpg`} alt="View of the Beach 1900 factory" />
          </div>
          <div className="facts_info info_reverse">
            <p>The aircraft was designed to carry passengers in all weather conditions from airports with relatively short runways. It is capable of flying in excess of 600 miles (970 km), although few operators use its full-fuel range. In terms of the number of aircraft built and its continued use by many passenger airlines and other users, it is one of the most popular 19-passenger airliners in history.</p>
