  ...
  render() {
    ...
    return (
      <section>
        ...
        <section
          className={this.props.store.toggleMenu ? 'home home-open' : 'home'}
        >
          ...
          if (data.name === null) {
            return (
              <div
                className={
                  i % 2
                    ? `grid-cell grid-cell-even grid-cell-${key}`
                    : `grid-cell grid-cell-odd grid-cell-${key}`
                }
                key={i}
              />
            );
            ...
            return (
              <Link
                to={key === 'accidentType' ? '/incidents' : '/airplanes'}
                onClick={() => {
                  this._decideLinks(data, key);
                }}
                key={i}
                className={
                  i % 2
