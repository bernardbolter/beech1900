...
export default class AirplaneSearch extends React.Component {
  ...
  render() {
    return (
      <div
        className={
          this.props.store.toggleSearch ? 'search search-open' : 'search'
        }
      >
        <div className="search-column-one">
          ...
          <label htmlFor="older" className="sort-label check-older">
            ...
            <input
              ...
              id="older"
              value="older"
              checked={this.props.store.olderChecked}
          ...
          <label htmlFor="newer" className="sort-label check-newer">
            ...
            <input
              ...
              id="newer"
              value="newer"
              checked={this.props.store.newerChecked}
              onChange={this.toggleSorting}
            />
          </label>
          <input
            ...
            type="text"
            value={this.props.store.airplaneFilter}
        ...
        <div className="search-column-two">
          ...
          <label htmlFor="ua" className="filter-label check-ua">
            <input
              ...
              id="ua"
              value="ua"
              checked={this.props.store.uaChecked}
          ...
          <label htmlFor="ub" className="filter-label check-ub">
            <input
              ...
              id="ub"
              value="ub"
              checked={this.props.store.ubChecked}
              onChange={this.toggleFilters}
            />
            <span> UB</span>
          </label>
          <label htmlFor="uc" className="filter-label check-uc">
            <input
              ...
              id="uc"
              value="uc"
              checked={this.props.store.ucChecked}
              onChange={this.toggleFilters}
            />
            <span> UC</span>
          </label>
          <label htmlFor="ud" className="filter-label check-ud">
            <input
              ...
              id="ud"
              value="ud"
              checked={this.props.store.udChecked}
              onChange={this.toggleFilters}
            />
            <span> UD</span>
          </label>
          <label htmlFor="ue" className="filter-label check-ue">
            <input
              ...
              id="ue"
              value="ue"
              checked={this.props.store.ueChecked}
              onChange={this.toggleFilters}
            />
            <span> UE</span>
          </label>
        ...
        <div className="search-column-three">
          <label htmlFor="operating" className="filter-label check-operating">
            <input
              ...
              id="operating"
              value="operating"
              checked={this.props.store.operatingChecked}
              onChange={this.toggleFilters}
            />
            <span> Operating</span>
          </label>
          ...
          >
            <input
              ...
              checked={this.props.store.operatingNonCurrentChecked}
              onChange={this.toggleFilters}
            />
          ...
          <label htmlFor="nonFlying" className="filter-label check-nonFlying">
            <input
              ...
              id="nonFlying"
              value="nonFlying"
              checked={this.props.store.nonFlyingChecked}
              onChange={this.toggleFilters}
            />
          ...
          <label htmlFor="partedOut" className="filter-label check-partedOut">
            <input
              ...
              id="partedOut"
              value="partedOut"
              checked={this.props.store.partedOutChecked}
              onChange={this.toggleFilters}
            />
          ...
          <label htmlFor="destroyed" className="filter-label check-destroyed">
            <input
              ...
              id="destroyed"
              value="destroyed"
              checked={this.props.store.destroyedChecked}
              onChange={this.toggleFilters}
            />
            <span> Destroyed</span>
          </label>
        ...
        <div className="search-column-four">
          ...
          <select
            value={this.props.store.operatorValue}
          ...
          <select
            value={this.props.store.countryValue}
  ...
  toggleFilters = e => {
    switch (e.target.value) {
      ...
      case 'operatingNonCurrent':
        this.props.store.operatingNonCurrentChecked = !this.props.store
  ...
  getOperatorDropdown = () => {
    ...
    const uniqOperators = operatorList.filter(function(
      item,
      index,
      inputArray
    ) {
