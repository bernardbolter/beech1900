    ...
    return (
      <div className={this.props.store.toggleSearch ? 'incident-search incident-search-open' : 'incident-search'}>
        ...
        <div className="incident-column-one">
          ...
          <input className="search-input filter" placeholder="search city, airport, operator, reg" type="text" value={this.props.store.incidentsFilter} onChange={this.filterIncidents} />
        </div>

        <div className="incident-column-two">
          <div className="search-reset" onClick={this.props.store.incidentsSearchReset}>
