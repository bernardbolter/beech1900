...
export default class AirplaneSearch extends React.Component {
        ...
        <div className="incident-column-one">
          ...
          <label htmlFor="older" className="sort-label check-older">
            ...
            <input
              ...
              id="older"
              value="older"
              checked={this.props.store.incidentsOlderChecked}
          ...
          <label htmlFor="newer" className="sort-label check-newer">
            ...
            <input
              ...
              id="newer"
              value="newer"
              checked={this.props.store.incidentsNewerChecked}
              onChange={this.toggleSorting}
            />
          </label>
          ...
          <input
            ...
            type="text"
            value={this.props.store.incidentsFilter}
        ...
        <div className="incident-column-two">
          ...
          <label htmlFor="fatalities" className="filter-label check-fatalities">
            <input
              ...
              id="fatalities"
              value="fatalities"
              checked={this.props.store.incidentsFatalitiesChecked}
              onChange={this.toggleFatalities}
            />
            <span> Fatalities</span>
          </label>
          <select
            value={this.props.store.incidentsTypeValue}
  ...
  toggleFatalities = () => {
    this.props.store.incidentsFatalitiesChecked = !this.props.store
  ...
  getIncidentTypeDropdown = () => {
    ...
    const uniqIncidentsType = incidentTypeList.filter(function(
      item,
      index,
      inputArray
    ) {
